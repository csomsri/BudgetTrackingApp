...
QT_MOC_LITERAL(1, 9, 9), // "GoToPage2"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 15) // "OnButtonClicked"

    },
    "HomePage\0GoToPage2\0\0OnButtonClicked"
};
...
void HomePage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HomePage::GoToPage2)) {
                *result = 0;
                return;
            }
        }
