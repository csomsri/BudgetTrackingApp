...
QT_MOC_LITERAL(1, 9, 9), // "GoToPage1"
QT_MOC_LITERAL(2, 19, 0) // ""

    },
    "Analyzer\0GoToPage1\0"
};
...
void Analyzer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->GoToPage1(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Analyzer::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Analyzer::GoToPage1)) {
                *result = 0;
                return;
            }
        }
